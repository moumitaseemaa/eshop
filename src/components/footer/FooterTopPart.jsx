...
const FooterTopPart = () => {
  return (
    <Container>
      ...
      >
        <h2 className="font-['Poppins'] font-semibold text-[36px] leading-[46px] mb-4">
          Get Our Updates
        </h2>
        ...
        <input
          type="text"
          className="w-[494px] p-6 border border-[#CCCCCC] bg-white rounded-[10px] font-['Montserrat'] font-normal text-base text-[#303030] leading-6 mt-8 mb-4 "
